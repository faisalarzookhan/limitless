  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const performanceData = [
        ...
        ['Largest Contentful Paint (LCP)', auditData.lcp || 'N/A', 'Under 2.5s'],
      ...
      const securityData = [
        ...
        ['Mixed Content', auditData.mixedContent || 'N/A', 'Resolve all issues'],
        ['Security Headers', auditData.securityHeaders || 'N/A', 'Implement best practices'],
        ['Vulnerabilities', auditData.vulnerabilities || 'N/A', 'Regular scanning required'],
      ];
      ...
      const seoData = [
        ...
        ['Meta Description', auditData.metaDescription || 'N/A', 'Compelling, 150-160 chars'],
        ['Header Tags', auditData.headerStructure || 'N/A', 'Proper H1-H6 hierarchy'],
        ['Image Alt Text', auditData.imageAltText || 'N/A', 'Descriptive, keyword-rich'],
      ...
      doc.setFontSize(10);
      doc.setTextColor(100, 100, 100);
      doc.text('Limitless Infotech Solution - Technical Audit Service', 20, pageHeight - 30);
      doc.text('Contact: Info@limitlessinfotech.com | +917710909492', 20, pageHeight - 20);
...
export const generateCustomReport = async (reportData) => {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.setFontSize(14);
      doc.setTextColor(100, 100, 100);
      doc.text(`Generated on: ${reportData.date || new Date().toLocaleDateString()}`, 20, 45);
