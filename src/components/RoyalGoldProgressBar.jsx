      ...
      <div className="relative">
        ...
        >
          ...
          <circle
            ...
            strokeDashoffset={circumference - (currentValue / 100) * circumference}
            strokeLinecap="round"
...
const AnimatedRoyalGoldProgressBar = ({ value, label, description }) => {
  ...
  return (
    <div className={`p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-yellow-50 border border-yellow-200 shadow-lg transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
...
export { RoyalGoldProgressBar, RoyalGoldProgressRow, AnimatedRoyalGoldProgressBar };