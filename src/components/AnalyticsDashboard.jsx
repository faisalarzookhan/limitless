          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {leadQuality.corporateLeadPercentage.toFixed(2)}%
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-2 border-b">
                ...
                <span className="font-semibold">
                  {conversionMetrics.auditorToSandboxRate.toFixed(2)}%
                </span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b">
                <span className="text-gray-600">Sandbox to Trial</span>
                <span className="font-semibold">
                  {conversionMetrics.sandboxToTrialRate.toFixed(2)}%
                </span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b">
                <span className="text-gray-600">Trial to Purchase</span>
                <span className="font-semibold">
                  {conversionMetrics.trialToPurchaseRate.toFixed(2)}%
                </span>
              </div>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-2 border-b">
                ...
                <span className="font-semibold">
                  {platformStickiness.averageDurationFormatted}
                </span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b">
                <span className="text-gray-600">Total Sessions</span>
                <span className="font-semibold">
                  {platformStickiness.totalSessions}
                </span>
              </div>
              <div className="flex justify-between items-center pt-2">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {Object.entries(userJourneyAnalytics.successRates).map(
                  ([journey, data]) => (
                    <tr key={journey}>
