...
const Progress = forwardRef<HTMLDivElement, ProgressProps>(({
  ...
  const baseIndicatorClasses = 'h-full rounded-full transition-all duration-500 ease-out';
    ...
    >
      {label && (
        <div className="flex justify-between mb-2">
          <span className="text-sm font-medium text-gray-700 dark:text-gray-300" id={`${progressId}-label`}>{label}</span>
          {showPercentage && (
