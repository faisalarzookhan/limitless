...
const Card = forwardRef<HTMLDivElement, CardProps & HTMLAttributes<HTMLDivElement>>(({
  ...
  const variantClasses = {
    default: 'bg-white dark:bg-dark-800/80 backdrop-blur-sm shadow-soft border border-gray-100/50 dark:border-dark-700/50',
    elevated: 'bg-white dark:bg-dark-800/80 backdrop-blur-sm shadow-xl border border-gray-100/50 dark:border-dark-700/50',
    outlined: 'bg-transparent border-2 border-gray-200 dark:border-dark-700',
    filled: 'bg-gray-50 dark:bg-dark-800',
    glass: 'bg-white/70 dark:bg-dark-800/60 backdrop-blur-xl border border-white/30 dark:border-dark-700/30 shadow-lg',
    gradient: 'bg-gradient-to-br from-white to-gray-50 dark:from-dark-800 dark:to-dark-900 shadow-soft border border-gray-100/50 dark:border-dark-700/50',
  };
