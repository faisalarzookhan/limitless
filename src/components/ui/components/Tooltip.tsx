...
const Tooltip = forwardRef<HTMLDivElement, TooltipProps>(({
  ...
  const arrowClasses = {
    ...
    bottom: 'bottom-full left-1/2 transform -translate-x-1/2 border-b border-r border-gray-900 dark:border-dark-700',
    left: 'left-full top-1/2 transform -translate-y-1/2 border-b border-l border-gray-900 dark:border-dark-700',
    right: 'right-full top-1/2 transform -translate-y-1/2 border-t border-r border-gray-900 dark:border-dark-700',
  };
