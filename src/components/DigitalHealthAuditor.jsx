...
const DigitalHealthAuditor = ({ onAuditComplete, onSandboxRequest }) => {
  ...
  const performAudit = async (targetUrl) => {
    ...
    try {
      ...
      const performanceMetrics = lighthouseService.extractPerformanceMetrics(lighthouseResult);
      const categoryScores = lighthouseService.extractCategoryScores(lighthouseResult);
      
      // Perform security scan
      const securityResults = await securityScanService.performSecurityScan(targetUrl);
      ...
      const performanceScore = Math.max(0, Math.min(100, 100 - (mockResults.performance.lcp / 2500) * 100));
      ...
      const speedScore = Math.max(0, Math.min(100, 100 - (mockResults.speed.loadTime / 5) * 100));
        ...
        {!scanResults && !isScanning ? (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">We'll analyze your site's performance, security, and SEO</p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Auditing Your Website</h2>
              <p className="text-gray-600 mb-6">Analyzing performance, security, and SEO metrics...</p>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <div className="flex flex-col md:flex-row items-center justify-between mb-8">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Audit Results for {url}</h2>
              ...
              {/* Limitless Score */}
              <div className="text-center mb-12">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Your Limitless Score</h3>
                <div className="flex justify-center">
                  <LimitlessScore score={limitlessScore} size={200} strokeWidth={8} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-blue-50 p-6 rounded-xl">
                  ...
                  <div className="text-blue-600 font-medium">Largest Contentful Paint</div>
                ...
                <div className="bg-green-50 p-6 rounded-xl">
                  ...
                  <div className="text-green-600 font-medium">Cumulative Layout Shift</div>
                  <div className="text-sm text-gray-600 mt-1">
                    Should be &lt; 0.1
                  </div>
                </div>
                ...
                <div className="bg-purple-50 p-6 rounded-xl">
                  ...
                  <div className="text-purple-600 font-medium">First Input Delay</div>
                  <div className="text-sm text-gray-600 mt-1">
                    Should be &lt; 100ms
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Performance Issues</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Security Issues</h4>
                  <div className="space-y-3">
                    <div>
                      <div className="font-medium text-sm text-gray-700 mb-1">SSL Certificate:</div>
                      <div className={`text-sm ${scanResults.security.sslValid ? 'text-green-600' : 'text-red-600'}`}>
                        {scanResults.security.sslValid ? 'Valid' : 'Invalid'}
                      </div>
                    </div>
                    <div>
                      <div className="font-medium text-sm text-gray-700 mb-1">Security Grade:</div>
                      <div className={`text-lg font-bold ${scanResults.security.grade === 'A+' || scanResults.security.grade === 'A' ? 'text-green-600' : scanResults.security.grade === 'B' || scanResults.security.grade === 'C' ? 'text-yellow-600' : 'text-red-600'}`}>
                        {scanResults.security.grade}
                      </div>
                    </div>
                    <div>
                      <div className="font-medium text-sm text-gray-700 mb-1">Overall Score:</div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-xl p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">Experience how TrackIT provides the stability you're missing</h3>
              <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
                Ready to improve your website's performance and resolve these issues? Try our TrackIT solution in our Instant Sandbox.
              </p>
              <button 
