      ...
      <div
        ...
        style={{
          top: currentStepData.position?.top
            ? `${parseInt(currentStepData.position.top) - 20}px`
            : '50%',
          left: currentStepData.position?.left
            ? `${parseInt(currentStepData.position.left) + parseInt(currentStepData.position.width || '300') / 2}px`
            : '50%',
        }}
      >
        ...
        <div
          ...
          style={{
            top: step.position?.top
              ? `${parseInt(step.position.top) - 10}px`
              : '50%',
            left: step.position?.left
              ? `${parseInt(step.position.left) - 10}px`
              : '50%',
          }}
        >
  ...
  trackIT: [
    {
      ...
      description:
        'Let me show you the powerful project management features of our TrackIT system.',
      highlightedFeature:
        'TrackIT helps manage projects with real-time collaboration and automated reporting.',
      position: { top: '10%', left: '50%', width: '250px', height: '60px' },
    },
    {
      title: 'Project Dashboard',
      description:
        'This is your central hub where you can see all active projects and their progress.',
      highlightedFeature:
        'Use the progress bars to quickly identify which projects need attention.',
      position: { top: '25%', left: '20%', width: '300px', height: '200px' },
    },
    {
      title: 'Task Management',
      description:
        'Create, assign, and track tasks with our intuitive interface.',
      highlightedFeature:
        'Tasks can be assigned to team members with due dates and priority levels.',
      position: { top: '40%', left: '60%', width: '280px', height: '180px' },
    },
    {
      title: 'Team Collaboration',
      description:
        'Collaborate with your team members in real-time with comments and updates.',
      highlightedFeature:
        'Use @mentions to notify specific team members about important updates.',
      position: { top: '60%', left: '30%', width: '320px', height: '150px' },
    },
    {
      title: 'Reporting & Analytics',
      description:
        'Generate detailed reports to analyze project performance and team productivity.',
      highlightedFeature:
  ...
  hrIMS: [
    {
      ...
      description:
        'This is our Human Resources Information Management System for comprehensive HR operations.',
      highlightedFeature:
        'HR-IMS streamlines employee management, payroll, and compliance processes.',
      position: { top: '10%', left: '50%', width: '250px', height: '60px' },
    },
    {
      title: 'Employee Directory',
      description:
        'Access comprehensive employee information with advanced search and filtering.',
      highlightedFeature:
        'Use the directory to quickly find employee contact information and details.',
      position: { top: '25%', left: '20%', width: '300px', height: '200px' },
    },
    {
      title: 'Payroll Management',
      description:
        'Process payroll, manage benefits, and track compensation with ease.',
      highlightedFeature:
        'Automatic tax calculations and compliance reporting are built-in.',
      position: { top: '40%', left: '60%', width: '280px', height: '180px' },
    },
    {
      title: 'Performance Reviews',
      description:
        'Conduct and track performance reviews with standardized templates.',
      highlightedFeature:
        'Set goals, track progress, and provide feedback all in one place.',
      position: { top: '60%', left: '30%', width: '320px', height: '150px' },
    },
    {
      title: 'Reporting Center',
      description:
        'Generate HR reports for compliance, analytics, and strategic planning.',
      highlightedFeature:
        'Reports include headcount, turnover, compensation analysis, and more.',
      position: { top: '70%', left: '70%', width: '260px', height: '120px' },
    },
  ],
};
