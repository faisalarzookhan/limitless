...
import { HiOutlineLightBulb, HiOutlineClock, HiOutlineUserCircle, HiOutlineChartBar } from 'react-icons/hi';
...
const SandboxEnvironment = ({ onExit }) => {
  ...
  useEffect(() => {
    const initializeSandbox = async () => {
      const sandbox = await sandboxService.createSandbox({ email: 'demo@user.com' });
  ...
  const handleSandboxExpiration = () => {
    alert('Your sandbox session has expired. Please contact us for a full demo.');
    if (onExit) onExit();
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              ...
              <p className="text-gray-600">
                Experience our SaaS solution with pre-loaded data and full functionality
              </p>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm font-medium text-gray-700">{Math.round(tourProgress)}%</span>
            </div>
              ...
              >
                ...
                <div className="flex-1">
                  <p className={`font-medium ${
                    index === currentStep ? 'text-yellow-800' : 'text-gray-900'
                  }`}>
                    {step}
                  </p>
                </div>
          ...
          {sandboxFeatures.map((feature, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-baseline">
                <span className="text-3xl font-bold text-indigo-600">{feature.value}</span>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Interactive Demo</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Try Creating a Project</h3>
              <div className="space-y-4">
                <div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Sandbox Benefits</h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <HiOutlineUserCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                  <span className="text-gray-700">Pre-populated with sample data</span>
                </li>
                <li className="flex items-start">
                  <HiOutlineUserCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                ...
                <li className="flex items-start">
                  <HiOutlineUserCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
                  <span className="text-gray-700">4 hours of exclusive access</span>
                </li>
                <li className="flex items-start">
                  <HiOutlineUserCircle className="w-5 h-5 text-green-500 mr-2 mt-0.5" />
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl shadow-xl p-8 mt-8 text-center">
          <h3 className="text-2xl font-bold text-yellow-900 mb-4">Ready to Transform Your Business?</h3>
          <p className="text-yellow-800 mb-6 max-w-2xl mx-auto">
            Experience the full power of TrackIT with a personalized demo or start your free trial today.
          </p>
