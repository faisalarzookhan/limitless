...
import { HiCode, HiDocumentText, HiTerminal, HiLockClosed, HiRefresh, HiUser, HiBriefcase, HiCalendar, HiChartBar } from 'react-icons/hi';
  ...
  const apiEndpoints = {
    ...
    products: [
      ...
      },
      {
        ...
        responses: [
          { code: 200, description: 'Product details retrieved', example: { id: 1, name: 'TrackIT', description: 'Project tracking solution', features: ['task management', 'time tracking'] } },
  ...
  const renderOverview = () => (
    <div className="space-y-8">
      <div className="bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-soft border border-gray-100 dark:border-dark-700">
        <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">API Overview</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Our RESTful API provides programmatic access to all platform features. All endpoints are secured with JWT authentication.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl">
            ...
            <h3 className="font-bold mb-2 text-gray-900 dark:text-white">RESTful Design</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Consistent, predictable API design following REST principles</p>
          </div>
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-xl">
            <HiLockClosed className="w-8 h-8 text-green-600 dark:text-green-400 mb-3" />
            <h3 className="font-bold mb-2 text-gray-900 dark:text-white">Secure by Default</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">JWT authentication and HTTPS encryption for all requests</p>
          </div>
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-xl">
            ...
            <h3 className="font-bold mb-2 text-gray-900 dark:text-white">Rate Limited</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Fair usage policies with rate limiting to ensure performance</p>
          </div>
        </div>

        <div className="bg-gray-50 dark:bg-dark-700 rounded-xl p-6">
          <h3 className="font-bold mb-4 text-gray-900 dark:text-white">Base URL</h3>
      ...
      <div className="bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-soft border border-gray-100 dark:border-dark-700">
        <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Authentication</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          All API requests require a valid JWT token in the Authorization header.
        </p>
        
        <div className="bg-gray-50 dark:bg-dark-700 rounded-xl p-6 mb-6">
          <h3 className="font-bold mb-3 text-gray-900 dark:text-white">Example Request</h3>
...
{`curl -X GET https://api.limitlessinfotech.com/v1/users/profile \\
  ...
  -H "Content-Type: application/json"`}
        ...
        <div className="bg-gray-50 dark:bg-dark-700 rounded-xl p-6">
          <h3 className="font-bold mb-3 text-gray-900 dark:text-white">Rate Limits</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Default rate limits:</p>
      ...
      {selectedEndpoint === endpoint.path && (
        <div className="space-y-6">
          {endpoint.headers && endpoint.headers.length > 0 && (
            <div>
              <h4 className="font-semibold mb-3 text-gray-900 dark:text-white">Headers</h4>
              <div className="space-y-2">
                {endpoint.headers.map((header, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-dark-700 rounded-lg">
                    <div className="flex items-center">
                      <span className="font-mono text-sm font-bold mr-3">{header.name}</span>
                      {header.required && <span className="text-xs bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400 px-2 py-1 rounded">Required</span>}
                    </div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">{header.description}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {endpoint.parameters.map((param, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-dark-700 rounded-lg">
                    <div className="flex items-center">
                      <span className="font-mono text-sm font-bold mr-3">{param.name}</span>
                      <span className="text-xs bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-300 px-2 py-1 rounded">{param.type}</span>
                      {param.required && <span className="text-xs bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400 px-2 py-1 rounded ml-2">Required</span>}
                    </div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">{param.description}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-3 text-gray-900 dark:text-white">Responses</h4>
            <div className="space-y-4">
              {endpoint.responses.map((response, idx) => (
                <div key={idx} className="bg-gray-50 dark:bg-dark-700 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="font-mono font-bold text-gray-900 dark:text-white">{response.code}</span>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-dark-900 dark:to-dark-800">
        ...
        <div className="container-custom px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="#playground" className="btn-primary bg-white text-indigo-600 hover:bg-gray-100">
                API Playground
              </a>
              <a href="#sdk" className="btn-outline border-white text-white hover:bg-white hover:text-indigo-600">
                Download SDK
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/4">
              <div className="bg-white dark:bg-dark-800 rounded-2xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 sticky top-8">
                <h3 className="font-bold mb-4 text-gray-900 dark:text-white">API Sections</h3>
      ...
      {/* API Playground */}
      <section id="playground" className="section-padding bg-gray-50 dark:bg-dark-800">
        <div className="container-custom">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Endpoint</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Authorization</label>
                    <input
                      type="password"
              ...
              <div>
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Response</h3>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">JavaScript</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">For Node.js and browser applications</p>
              <code className="block text-xs bg-gray-100 dark:bg-dark-700 p-2 rounded mb-3">npm install @limitlessinfotech/api</code>
              <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:underline text-sm">Documentation</a>
            </div>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">Python</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">For Python applications</p>
              <code className="block text-xs bg-gray-100 dark:bg-dark-700 p-2 rounded mb-3">pip install limitlessinfotech-api</code>
              <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:underline text-sm">Documentation</a>
            </div>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">Java</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">For Java applications</p>
              <code className="block text-xs bg-gray-100 dark:bg-dark-700 p-2 rounded mb-3">Maven dependency</code>
              <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:underline text-sm">Documentation</a>
            </div>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">.NET</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">For .NET applications</p>
              <code className="block text-xs bg-gray-100 dark:bg-dark-700 p-2 rounded mb-3">NuGet package</code>
              <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:underline text-sm">Documentation</a>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Get started with our API today and unlock the full potential of our platform
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/contact" className="btn-primary bg-white text-indigo-600 hover:bg-gray-100">
                Get API Access
              </a>
              <a href="/api-documentation" className="btn-outline border-white text-white hover:bg-white hover:text-indigo-600">
                View Full Docs
              </a>
            </div>
          </div>
