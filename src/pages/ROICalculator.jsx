...
import { HiCurrencyDollar, HiChartBar, HiLightningBolt, HiUserGroup, HiClock, HiTrendingUp, HiCalculator } from 'react-icons/hi';
...
const ROICalculator = () => {
  ...
  const calculators = {
    'hr-ims': {
      ...
      description: 'Calculate the return on investment for implementing our HR Information Management System',
      icon: HiUserGroup,
      inputs: [
        { id: 'employeeCount', label: 'Number of Employees', type: 'number', min: 1, max: 10000, step: 1 },
        { id: 'avgSalary', label: 'Average Annual Salary per Employee ($)', type: 'number', min: 10000, max: 500000, step: 1000 },
        { id: 'timeSavedPerEmployee', label: 'Hours Saved per Employee per Month', type: 'number', min: 0.5, max: 40, step: 0.5 },
        { id: 'costReductionPercentage', label: 'Percentage Cost Reduction (%)', type: 'number', min: 1, max: 50, step: 1 }
      ]
    },
    'trackit': {
      title: 'TrackIT ROI Calculator',
      description: 'Calculate the return on investment for implementing our Project Tracking Solution',
      icon: HiChartBar,
      inputs: [
        { id: 'projectCount', label: 'Number of Projects per Year', type: 'number', min: 1, max: 1000, step: 1 },
        { id: 'avgProjectValue', label: 'Average Project Value ($)', type: 'number', min: 1000, max: 1000000, step: 1000 },
        { id: 'timeToComplete', label: 'Average Time to Complete (Days)', type: 'number', min: 1, max: 365, step: 1 },
        { id: 'efficiencyGain', label: 'Efficiency Gain (%)', type: 'number', min: 1, max: 100, step: 1 }
      ]
    }
  };
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/2">
              <div className="bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-soft border border-gray-100 dark:border-dark-700 sticky top-8">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Select Product</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-gray-200 dark:border-dark-600 pt-6">
                    <h4 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">General Parameters</h4>
            ...
            <div className="lg:w-1/2">
              <div className="bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-soft border border-gray-100 dark:border-dark-700">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">ROI Results</h2>
                ...
                {results && (
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-xl border border-green-200 dark:border-green-800">
                        <div className="flex items-center mb-3">
                          ...
                          <h3 className="font-semibold text-gray-900 dark:text-white">Net Benefits</h3>
                        </div>
                        <p className="text-3xl font-bold text-green-600 dark:text-green-400 mb-1">
                          ${results.netBenefits.toLocaleString()}
                        </p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Total value after implementation costs</p>
                      </div>
                      
                      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl border border-blue-200 dark:border-blue-800">
                        <div className="flex items-center mb-3">
                          <HiTrendingUp className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2" />
                          <h3 className="font-semibold text-gray-900 dark:text-white">ROI</h3>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-xl border border-purple-200 dark:border-purple-800">
                        <div className="flex items-center mb-3">
                          ...
                          <h3 className="font-semibold text-gray-900 dark:text-white">Payback Period</h3>
                        </div>
                        <p className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-1">
                          {results.paybackPeriod} months
                        </p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Time to recover investment</p>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 p-6 rounded-xl border border-amber-200 dark:border-amber-800">
                        <div className="flex items-center mb-3">
                          ...
                          <h3 className="font-semibold text-gray-900 dark:text-white">Annual Savings</h3>
                        </div>
                        <p className="text-3xl font-bold text-amber-600 dark:text-amber-400 mb-1">
                          ${results.yearlySavings.toLocaleString()}
                        </p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Value gained per year</p>
                      </div>
                    </div>

                    <div className="bg-gray-50 dark:bg-dark-700 rounded-xl p-6">
                      <h3 className="font-semibold mb-4 text-gray-900 dark:text-white">Breakdown</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">Total Benefits ({inputs.timeframe} months):</span>
                          <span className="font-medium text-gray-900 dark:text-white">${results.totalBenefits.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">Implementation Cost:</span>
                          <span className="font-medium text-gray-900 dark:text-white">-${inputs.implementationCost.toLocaleString()}</span>
                        </div>
                        <div className="border-t border-gray-200 dark:border-dark-600 pt-3">
                          <div className="flex justify-between font-semibold">
                            <span className="text-gray-900 dark:text-white">Net Benefits:</span>
                            <span className={`text-lg ${results.netBenefits >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                              ${results.netBenefits.toLocaleString()}
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
                      <h3 className="font-semibold mb-3 text-gray-900 dark:text-white">Recommendation</h3>
              ...
              <div className="mt-8 bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-soft border border-gray-100 dark:border-dark-700">
                <h3 className="text-xl font-bold mb-6 text-gray-900 dark:text-white">Industry Benchmarks</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-dark-700 rounded-lg">
                    <span className="text-gray-700 dark:text-gray-300">Average HR Software ROI</span>
                    <span className="font-semibold text-gray-900 dark:text-white">187%</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-dark-700 rounded-lg">
                    <span className="text-gray-700 dark:text-gray-300">Average Project Management ROI</span>
                    <span className="font-semibold text-gray-900 dark:text-white">156%</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-dark-700 rounded-lg">
                    <span className="text-gray-700 dark:text-gray-300">Average Payback Period</span>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">
              How the <span className="text-gradient">ROI Calculator</span> Works
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Our calculator uses industry-standard formulas to estimate your potential return on investment
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Input Your Data</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Enter your specific business metrics and requirements to get personalized calculations
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Calculate Benefits</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Our algorithm calculates time savings, cost reductions, and efficiency gains
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">See Your ROI</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Get detailed breakdown of your potential return on investment and payback period
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Use our calculator to see the potential value of our solutions for your business
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/roi-calculator" className="btn-primary bg-white text-blue-600 hover:bg-gray-100">
                Start Calculating
              </a>
