...
import { HiShieldCheck, HiDocumentText, HiLockClosed, HiUserGroup, HiGlobe, HiCheckCircle } from 'react-icons/hi';
...
const Compliance = () => {
  const complianceStandards = [
    {
      id: 'soc2',
      title: 'SOC 2 Type II',
      description: 'Our systems undergo rigorous annual audits to ensure security, availability, processing integrity, confidentiality, and privacy of customer data.',
      logo: 'SOC 2',
      status: 'Certified',
    ...
    },
    {
      ...
      description: 'We adhere to the strictest data protection standards in the European Union, ensuring your data privacy rights are always protected.',
      logo: 'GDPR',
      status: 'Compliant',
      expiry: 'Ongoing',
      details: [
    ...
    },
    {
      id: 'iso27001',
      title: 'ISO 27001',
      description: 'International standard for information security management systems, demonstrating our commitment to maintaining secure information handling.',
      logo: 'ISO 27001',
      status: 'Certified',
    ...
    },
    {
      ...
      description: 'Health Insurance Portability and Accountability Act compliance for healthcare data handling and protection.',
      logo: 'HIPAA',
      status: 'Compliant',
      expiry: 'Ongoing',
      details: [
  ...
  const complianceFeatures = [
    ...
    },
    {
      ...
      description: '24/7 incident response team with documented response procedures',
      icon: HiCheckCircle
    },
    {
        ...
        <div className="container-custom px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 bg-white/20 px-6 py-3 rounded-full mb-8">
              ...
              <span className="text-sm font-semibold">Enterprise Security & Compliance</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Our commitment to the highest standards of data protection, security, and regulatory compliance
            </p>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              We maintain the highest levels of security and compliance certifications to protect your business data
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {complianceStandards.map((standard, index) => (
              <div key={standard.id} className="bg-white dark:bg-dark-800 rounded-2xl p-8 shadow-soft border border-gray-100 dark:border-dark-700 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 rounded-lg p-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    <strong>Assessment:</strong> Validated by independent auditors with no critical findings
                  </p>
                </div>
              </div>
            ))}
      ...
      <section className="section-padding bg-gray-50 dark:bg-dark-800">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Our comprehensive approach to protecting your data and maintaining system integrity
            </p>
          </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Built-in tools and features that help you maintain compliance with industry regulations
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {complianceFeatures.map((feature, index) => (
              <div key={index} className="flex items-start space-x-6 p-6 bg-white dark:bg-dark-800 rounded-2xl shadow-soft border border-gray-100 dark:border-dark-700">
        ...
        <div className="container-custom">
          <div className="bg-gradient-to-br from-white to-primary-50 dark:from-dark-900 dark:to-dark-800 rounded-3xl p-12 md:p-16 text-center border border-primary-200 dark:border-dark-700">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
              Our security team is ready to discuss how we can meet your specific compliance requirements
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
