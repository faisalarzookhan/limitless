        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {mockKPIs.map((kpi, index) => (
              <div
                key={index}
                className="bg-white dark:bg-dark-800 rounded-xl shadow p-6 border border-gray-200 dark:border-dark-700"
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={`text-sm mt-1 ${kpi.change.startsWith('+') ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                    >
              ...
              <div className="space-y-4">
                {mockTopPages.map((page, index) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-sm font-medium ${page.change.startsWith('+') ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                    >
                      {page.change}
                    </span>
                  </div>
