  ...
  const mainServices = [
    {
      ...
      technologies: ['React', 'Next.js', 'Vue', 'Angular', 'Node.js', 'PHP', 'WordPress', 'Shopify'],
      benefits: [
    ...
    },
    {
      ...
      technologies: ['Python', '.NET', 'Java', 'C#', 'Microservices', 'Docker', 'Kubernetes'],
      benefits: [
    ...
    },
    {
      ...
      technologies: ['React', 'Node.js', 'PostgreSQL', 'Redis', 'WebSockets', 'REST APIs'],
      benefits: [
    ...
    },
    {
      ...
      technologies: ['Python', 'TensorFlow', 'OpenAI', 'Azure AI', 'Power Automate', 'Zapier'],
      benefits: [
  ...
  const processSteps = [
    {
      ...
      description: 'We understand your business, goals, and challenges to create a comprehensive project plan.',
      icon: HiUsers
    },
    {
      number: '02',
    ...
    },
    {
      ...
      description: 'Deploy to production and provide ongoing support to ensure continued success.',
      icon: HiCheckCircle
    }
  ];
        ...
        <div className="container-custom px-4 md:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 bg-white/20 px-6 py-3 rounded-full mb-8 animate-fade-in-down">
              ...
              <span className="text-sm font-semibold">Comprehensive Technology Solutions</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              From web and mobile development to AI-powered automation, we deliver end-to-end solutions that drive growth and innovation.
            </p>
            <Link to="/get-started" className="btn-primary bg-white text-primary-600 hover:bg-gray-100 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              Start Your Project
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-white/90">
                Bank-level encryption, secure coding practices, and compliance with industry standards
              </p>
            </div>
            <div className="text-center">
