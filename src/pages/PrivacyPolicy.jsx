      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-600 text-white overflow-hidden">
        ...
        <div className="container-custom px-4 md:px-8 lg:px-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              We are committed to protecting your personal information and your right to privacy
            </p>
            <p className="text-sm text-white/80 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="container-custom max-w-4xl">
          ...
          <div className="space-y-10">
            {sections.map((section, index) => (
              <div key={index} className="border-b border-gray-200 dark:border-dark-700 pb-10 last:border-b-0">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className="space-y-2 text-gray-700 dark:text-gray-300">
                  <p><strong>Email:</strong> Info@limitlessinfotech.com</p>
                  <p><strong>Phone:</strong> +91 77109 09492</p>
