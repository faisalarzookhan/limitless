...
import { HiSearch, HiDocumentText, HiCode, HiBookOpen, HiVideoCamera, HiSparkles, HiLightningBolt, HiAcademicCap, HiChatAlt, HiClock, HiUserGroup, HiChartBar } from 'react-icons/hi';
...
const KnowledgeBase = () => {
  ...
  const categories = [
    ...
    { id: 'best-practices', name: 'Best Practices', icon: HiLightningBolt, count: 17 }
  ];
        ...
        <div className="container-custom px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Find answers, guides, and resources with our intelligent search system
            </p>
      ...
      <section className="section-padding bg-white dark:bg-dark-900">
        <div className="container-custom">
          <div className="max-w-6xl mx-auto">
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Browse Resources</h2>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Our intelligent search system understands context, intent, and provides relevant results
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Natural Language Search</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Ask questions in plain English and get precise answers from our knowledge base
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Smart Suggestions</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Get intelligent suggestions based on your search history and common queries
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Contextual Results</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Results are ranked by relevance and context to your specific needs
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="/api-documentation" className="bg-white dark:bg-dark-800 rounded-2xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 hover:shadow-lg transition-shadow duration-300 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">API Documentation</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Complete API reference and examples</p>
            </a>
            
            <a href="/compliance" className="bg-white dark:bg-dark-800 rounded-2xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 hover:shadow-lg transition-shadow duration-300 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">Compliance</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Security and compliance information</p>
            </a>
            
            <a href="/roi-calculator" className="bg-white dark:bg-dark-800 rounded-2xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 hover:shadow-lg transition-shadow duration-300 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">ROI Calculator</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Calculate your investment returns</p>
            </a>
            
            <a href="/client-portal" className="bg-white dark:bg-dark-800 rounded-2xl p-6 shadow-soft border border-gray-100 dark:border-dark-700 hover:shadow-lg transition-shadow duration-300 text-center">
              ...
              <h3 className="font-bold mb-2 text-gray-900 dark:text-white">Client Portal</h3>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="/docs" className="btn-outline border-white text-white hover:bg-white hover:text-indigo-600">
                Browse All Docs
              </a>
            </div>
          </div>
