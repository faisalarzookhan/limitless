...
const KnowledgeBase = () => {
  ...
  const resources = [
    {
      id: 1,
      title: 'Auralis AI: Core Integration Protocol',
      description: 'Comprehensive guide to synchronizing your enterprise data nodes with the Auralis Neural Engine.',
      category: 'documentation',
      type: 'api',
      date: 'Jan 22, 2024',
      readTime: '15 min read',
      tags: ['auralis-ai', 'integration', 'neural-nodes'],
      url: '/docs/auralis-core',
    },
    {
      id: 2,
      title: 'Cloud Sculpting: Elastic Scaling Architecture',
      description: 'Architectural blueprints for deploying ultra-scalable elastic environments on global fiber grids.',
      category: 'best-practices',
      type: 'guide',
      date: 'Jan 18, 2024',
      readTime: '12 min read',
      tags: ['cloud-sculpting', 'scalability', 'enterprise'],
      url: '/docs/cloud-sculpting-best-practices',
    },
    {
      id: 3,
      title: 'Limitless API Reference v2.4',
      description: 'Terminal documentation for mission-critical API endpoints, including rate limits and protocol buffers.',
      category: 'api',
      type: 'api',
      date: 'Jan 15, 2024',
      readTime: '25 min read',
      tags: ['api-docs', 'v2.4', 'endpoints'],
      url: '/docs/api-reference',
    },
    {
      id: 4,
      title: 'Neural Security: Zero-Trust Synthesis',
      description: 'Implementing high-fidelity encryption buffers and biometric handshakes across distributed nodes.',
      category: 'best-practices',
      type: 'security',
      date: 'Jan 12, 2024',
      readTime: '18 min read',
      tags: ['security', 'zero-trust', 'neural-encryption'],
      url: '/docs/security-synthesis',
    },
    {
      id: 5,
      title: 'OmniTrack Sandbox Configuration',
      description: 'Step-by-step tutorial for initializing your first OmniTrack sandbox via the Auditor trajectory.',
      category: 'tutorials',
      type: 'video',
      date: 'Jan 08, 2024',
      readTime: '10 min watch',
      tags: ['omnitrack', 'sandbox', 'tutorials'],
      url: '/videos/sandbox-setup',
    },
    {
      id: 6,
      title: 'ROI Diagnostic: Fiscal Yield Analysis',
      description: 'Understanding the deterministic ROI models utilized by our diagnostic auditors.',
      category: 'tools',
      type: 'tool',
      date: 'Jan 05, 2024',
      readTime: '5 min read',
      tags: ['roi', 'analytics', 'fiscal-yield'],
      url: '/roi-calculator',
    },
    {
      id: 7,
      title: 'Distributed System Protocols',
      description: 'Whitepaper on managing multi-regional node synchronization and latency optimization.',
      category: 'documentation',
      type: 'guide',
      date: 'Jan 02, 2024',
      readTime: '20 min read',
      tags: ['distributed-systems', 'latency', 'nodes'],
      url: '/docs/distributed-protocols',
    },
    {
      id: 8,
      title: 'Subdomain Routing & Scalability',
      description: 'Advanced guide to the Limitless SubdomainRouter logic for high-traffic enterprise ecosystems.',
      category: 'api',
      type: 'api',
      date: 'Dec 28, 2023',
      readTime: '14 min read',
      tags: ['subdomain-routing', 'scalability', 'router-v3'],
      url: '/docs/subdomain-routing',
    }
  ];
