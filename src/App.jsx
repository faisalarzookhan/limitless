  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path="/NaturalLanguageQueryPage"
          element={<NaturalLanguageQueryPage />}
        />
        <Route path="/Careers/Apply/:JobId" element={<JobApplication />} />
        <Route
          path="/WhatsAppIntegrationPage"
          element={<WhatsAppIntegrationPage />}
        />
        <Route path="/AuralisAIPage" element={<AuralisAIPage />} />
        <Route
          path="/DigitalHealthAuditorPage"
          element={<DigitalHealthAuditorPage />}
        />
        <Route
          path="/PredictiveAnalyticsPage"
          element={<PredictiveAnalyticsPage />}
        />
        <Route
          path="/LeadGenerationFormsPage"
          element={<LeadGenerationFormsPage />}
        />
        <Route
          path="/AnalyticsDashboardPage"
          element={<AnalyticsDashboardPage />}
        />
        <Route
          path="/AuralisPersonalizationDemoPage"
          element={<AuralisPersonalizationDemoPage />}
        />
